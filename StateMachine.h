...
StateMachine::StateMachine(NumberGame &game, unsigned buttonUpPin, unsigned buttonOkPin) : 
                            game(game), buttonUpPin(buttonUpPin), buttonOkPin(buttonOkPin)
{
